...
The function `grid_designation()` designates observations to cells of a given grid to create an aggregated data cube based on a random point within the uncertainty circle around each observation (each possible point within the uncertainty circle has the same probability to be selected).
