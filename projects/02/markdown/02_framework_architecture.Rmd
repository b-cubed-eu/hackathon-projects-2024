...
The tests can be performed for each function in each script or you can run the markdown file (`markdown > 03_unit_testing.Rmd`) to run all tests.
...
They can be placed in the `markdown` folder or in a new folder.
